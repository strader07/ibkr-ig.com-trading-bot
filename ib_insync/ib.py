...
from ib_insync.order import (
    BracketOrder, MarketOrder, LimitOrder, MidPriceOrder, TrailingStopOrder, Order, OrderState, OrderStatus, StopOrder, Trade)
    ...
    **user code may not block for too long**.
    ...
    def bracketMarketOrder(
        ...
        takeProfit = LimitOrder(
            ...
            **kwargs)
        return BracketOrder(parent, takeProfit, None)
